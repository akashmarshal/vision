...
public class BuildSchedulesDetailsVb extends CommonVb {
	...
	private String fullBuildFlag = "N";
	...
	public String getFullBuildFlag() {
		return fullBuildFlag;
	}
	public void setFullBuildFlag(String fullBuildFlag) {
		this.fullBuildFlag = fullBuildFlag;
	}
